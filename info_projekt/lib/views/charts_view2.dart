...
class ChartStock2 extends StatefulWidget {
  final String title;
  const ChartStock2({
    Key? key,
    required this.title,
  ...
  @override
  State<ChartStock2> createState() => _ChartStock2State();
}
...
class _ChartStock2State extends State<ChartStock2> {
      ...
      builder: (BuildContext context, AsyncSnapshot<List<dynamic>> snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          if (snapshot.data != null) {
            ...
            return WillPopScope(
              // TODO: i stopped here, please check if this work on android
              onWillPop: () async {
